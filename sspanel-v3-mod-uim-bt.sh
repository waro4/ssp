...
wget -N --no-check-certificate "https://raw.githubusercontent.com/waro4/ssp/master/ssp.zip"
unzip dev.zip
...
mysql -u$mysqlusername -p$mysqlpassword $mysqldatabase < 2021.10.sql >/dev/null 2>&1
mysql -u$mysqlusername -p$mysqlpassword $mysqldatabase < 2021.11.sql>/dev/null 2>&1
mysql -u$mysqlusername -p$mysqlpassword $mysqldatabase < 2021.12.sql >/dev/null 2>&1
mysql -u$mysqlusername -p$mysqlpassword $mysqldatabase < clean.sql >/dev/null 2>&1
mysql -u$mysqlusername -p$mysqlpassword $mysqldatabase < clean_job.sql >/dev/null 2>&1
mysql -u$mysqlusername -p$mysqlpassword $mysqldatabase < detect_ban_log.sql >/dev/null 2>&1
mysql -u$mysqlusername -p$mysqlpassword $mysqldatabase < email_queue.sql >/dev/null 2>&1
mysql -u$mysqlusername -p$mysqlpassword $mysqldatabase < support_trojan.sql >/dev/null 2>&1
mysql -u$mysqlusername -p$mysqlpassword $mysqldatabase < user_hourly_usage.sql>/dev/null 2>&1
mysql -u$mysqlusername -p$mysqlpassword $mysqldatabase < user_subscribe_log.sql >/dev/null 2>&1
